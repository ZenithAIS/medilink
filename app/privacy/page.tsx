...
export const metadata: Metadata = {
  ...
  description:
    "سیاست حریم خصوصی مدیلینک درباره‌ی جمع‌آوری، نگهداری و پردازش داده‌ی کاربران و بیماران.",
...
const sections = [
  ...
  },
  {
    ...
    body: [
      "در صورت استفاده‌ی کلینیک از سامانه‌های مدیلینک، داده‌ی بیماران در نقش پردازشگر داده و بر اساس دستور کلینیک پردازش می‌شود؛ مالک داده همچنان کلینیک است.",
  ...
  },
  {
    ...
    body: [
      ...
      "پس از پایان همکاری، خروجی کامل داده به کلینیک تحویل و نسخه‌های مدیلینک حذف می‌شود.",
    ],
  },
  {
    title: "۶. حقوق شما",
