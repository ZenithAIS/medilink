...
export const metadata: Metadata = {
  title: "درباره‌ی ما | مدی‌لینک",
  description:
    "مدی‌لینک تیمی از مهندسان نرم‌افزار و متخصصان حوزه‌ی سلامت است که سیستم‌های هوش مصنوعی و اتوماسیون برای کلینیک‌ها می‌سازد.",
...
const timeline = [
  {
    ...
    body: "بنیان‌گذاران مدی‌لینک در پروژه‌ای برای یک کلینیک پوست دیدند که بیش از نیمی از وقت منشی صرف کارهای تکراری می‌شود.",
  },
  {
    year: "۱۴۰۳",
  ...
  },
  {
    ...
    body: "مدی‌لینک امروز در کلینیک‌های پوست، دندانپزشکی، چشم‌پزشکی و پلی‌کلینیک‌های چندشعبه‌ای استفاده می‌شود.",
  },
];
  ...
  return (
    <main>
      ...
      <FinalCta
        ...
        description="در یک جلسه‌ی کوتاه، وضعیت فعلی کلینیک را بررسی می‌کنیم و می‌گوییم آیا مدی‌لینک به کار شما می‌آید یا نه."
        cta="تماس با ما"
      />
    </main>
  );
