...
export const metadata: Metadata = {
  title: "قوانین و مقررات | مدی‌لینک",
  description:
    "شرایط استفاده از وب‌سایت و سرویس‌های مدی‌لینک، تعهدات طرفین و محدودیت مسئولیت.",
...
const sections = [
  {
    title: "۱. پذیرش شرایط",
    body: [
      "استفاده از وب‌سایت و سرویس‌های مدی‌لینک به معنای پذیرش این شرایط است. در صورت عدم موافقت، لطفاً از سرویس استفاده نکنید.",
    ],
  },
  {
    title: "۲. شرح سرویس",
    body: [
      "مدی‌لینک نرم‌افزار مدیریت و اتوماسیون کلینیک ارائه می‌دهد. مدی‌لینک ارائه‌دهنده‌ی خدمات درمانی نیست و هیچ توصیه‌ی پزشکی ارائه نمی‌کند.",
  ...
  },
  {
    ...
    body: [
      "مدی‌لینک تلاش می‌کند دسترس‌پذیری سرویس را در بالاترین سطح ممکن حفظ کند؛ توقف‌های برنامه‌ریزی‌شده از پیش اطلاع‌رسانی می‌شود.",
  ...
  },
  {
    title: "۶. مالکیت فکری",
    body: [
      "کلیه‌ی حقوق نرم‌افزار، طراحی و محتوای وب‌سایت متعلق به مدی‌لینک است.",
